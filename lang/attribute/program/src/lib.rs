...
///
/// [here]: https://github.com/coral-xyz/anchor/tree/v0.32.2/tests/declare-program
#[proc_macro]
...
#[deprecated(
    ...
    See examples in https://github.com/coral-xyz/anchor/tree/v0.32.2/tests/spl/transfer-hook"
)]
#[proc_macro_attribute]
pub fn interface(
    _args: proc_macro::TokenStream,
