...
- If you installed the version `0.31.2`, run `avm use 0.31.2`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v0.31.2 anchor-cli
```
