...
- If you installed the version `1.1.1`, run `avm use 1.1.1`.
...
```shell title="Terminal"
cargo install --git https://github.com/otter-sec/anchor --tag v1.1.1 anchor-cli
```
