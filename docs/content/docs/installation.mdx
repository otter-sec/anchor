...
- If you installed the version `0.32.2`, run `avm use 0.32.2`.
...
```shell title="Terminal"
cargo install --git https://github.com/coral-xyz/anchor --tag v0.32.2 anchor-cli
```
