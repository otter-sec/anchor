...
**Try it live.** The four examples above, derived in the browser from this
page's program id. Press **Generate** on the signer keypair and only the PDA
with the dynamic seed changes; edit the program id and the `seeds::program` PDA
stays put.
