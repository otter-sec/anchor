...
[CHANGELOG](https://github.com/otter-sec/anchor/blob/v0.31.0/CHANGELOG.md#0310---2025-03-08).
...
[#2955](https://github.com/otter-sec/anchor/issues/2955),
[#3113](https://github.com/otter-sec/anchor/issues/3113), and
[#3196](https://github.com/otter-sec/anchor/issues/3196).
...
frame ([#2939](https://github.com/otter-sec/anchor/pull/2939)).
...
issue in [otter-sec/anchor](https://github.com/otter-sec/anchor/issues/3097).
...
See
[example](https://github.com/otter-sec/anchor/blob/v0.31.0/tests/custom-discriminator/programs/custom-discriminator/src/lib.rs).
...
- Being unable to use constant bytes
  ([#3287](https://github.com/otter-sec/anchor/pull/3287))
- Missing docs from the generated constants
  ([#3311](https://github.com/otter-sec/anchor/pull/3311))
- Compilation errors related to incorrectly adding `derive`s and `repr`s to type
  aliases ([#3504](https://github.com/otter-sec/anchor/pull/3504))
- Being unable to use `data` as an instruction parameter
  ([#3574](https://github.com/otter-sec/anchor/pull/3574))
...
See [otter-sec/anchor#3216](https://github.com/otter-sec/anchor/pull/3216) for
more information.
...
[`build_idl`](https://github.com/otter-sec/anchor/blob/v0.31.0/idl/src/build.rs#L119)
...
[#3450](https://github.com/otter-sec/anchor/pull/3450).
...
[`tokio` example](https://github.com/otter-sec/anchor/blob/v0.31.0/client/example/src/nonblocking.rs#L65-L99).
