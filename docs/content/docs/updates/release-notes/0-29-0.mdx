...
Anchor keeps a
[CHANGELOG](https://github.com/otter-sec/anchor/blob/master/CHANGELOG.md) but
...
- `anchor_version` requires
  [`avm`](https://github.com/otter-sec/anchor/tree/master/avm) to be installed.
...
- Even though most of it works great, some parts are still rough around the
  ...
  [create an issue](https://github.com/otter-sec/anchor/issues) if you run into
  a problem.
...
properly with
`idl-build`([#2640](https://github.com/otter-sec/anchor/issues/2640)).
...
[binary size](https://github.com/otter-sec/anchor/blob/master/bench/BINARY_SIZE.md#0290)
which is reduced ~36% compared to `0.28.0`!

Similar benchmarks can be found for
[compute units](https://github.com/otter-sec/anchor/blob/master/bench/COMPUTE_UNITS.md#0290)
and
[stack memory](https://github.com/otter-sec/anchor/blob/master/bench/STACK_MEMORY.md#0290).
...
[CHANGELOG](https://github.com/otter-sec/anchor/blob/master/CHANGELOG.md#0290---2023-10-16).
